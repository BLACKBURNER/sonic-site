...
const STEPS = [
  {
    ...
    description: 'Wir analysieren Ihre Ziele, Zielgruppe und Event-Anforderungen.',
    accent: 'Analyse & Strategie',
    duration: '1–2 Tage',
  },
  {
    number: '02',
    ...
    description: 'Kreative Standgestaltung und Aktivierungskonzepte für maximale Wirkung.',
    accent: 'Kreation',
    duration: '3–5 Tage',
  },
  {
    ...
    description: 'Auswahl und Schulung des perfekten Teams für Ihren Event.',
    accent: 'HR & Training',
    duration: '5–7 Tage',
  },
  {
    ...
    icon: 'ri-tools-line',
    title: 'Vorbereitung',
    description: 'Logistik, Equipment-Check und finale Briefings vor Ort.',
    accent: 'Logistik',
    duration: '2–3 Tage',
  },
  {
    ...
    title: 'Event-Durchführung',
    description: 'Professionelle Umsetzung mit Live-Support und Monitoring.',
    accent: 'Umsetzung',
  ...
  },
  {
    ...
    title: 'Reporting',
    description: 'Detaillierte Auswertung mit KPIs, Insights und Optimierungsvorschlägen.',
    accent: 'Analyse & Export',
    duration: '3–5 Tage',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            Von der Planung bis zum Reporting — professionell und zuverlässig.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 p-8 flex flex-col" style={{ minHeight: '460px' }}>
                  ...
                  {/* 3D Icon box */}
                  <div className="w-[64px] h-[64px] flex items-center justify-center mb-7 flex-shrink-0" style={{ background: isA ? 'linear-gradient(145deg, #d4e100, #C8D400)' : 'linear-gradient(145deg, #1c1c1c, #111)', boxShadow: isA ? '0 12px 28px rgba(200,212,0,0.35), inset 0 1px 0 rgba(255,255,255,0.4), inset 0 -1px 0 rgba(0,0,0,0.15)' : '0 12px 28px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.08)', transition: 'all 0.35s ease' }}>
