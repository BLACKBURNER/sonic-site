...
const DELIVERABLES = [
  {
    number: '01',
    icon: 'ri-store-line',
    title: 'POS-Materialien',
    description: 'Displays, Aufsteller, Regalstopper und weitere Verkaufshilfen für den Point of Sale. Produktion, Lager und Logistik aus einer Hand.',
    tags: ['Displays', 'Aufsteller', 'Regalstopper'],
    accent: 'Material & Produktion',
  },
  {
    number: '02',
    icon: 'ri-team-line',
    title: 'Geschultes Personal',
    description: 'Professionelle Promoter für Produktvorführungen, Verkaufsunterstützung und Regalpflege — handverlesen und bestens geschult.',
    tags: ['Promoter', 'Schulung', 'Support'],
    accent: 'People & Aktivierung',
  },
  {
    number: '03',
    icon: 'ri-map-pin-line',
    title: 'Flächenmanagement',
    description: 'Optimale Platzierung und dauerhafte Verwaltung Ihrer Produkte im Handel. Zweitplatzierungen, Regalpflege, Warenpräsentation.',
    tags: ['Platzierung', 'Verwaltung', 'Optimierung'],
    accent: 'Fläche & Präsenz',
  },
  {
    number: '04',
    icon: 'ri-bar-chart-line',
    title: 'Performance-Tracking',
    description: 'Detaillierte Auswertung von Verkaufszahlen und ROI Ihrer POS-Aktivitäten — tagesaktuell im Sonic Reporting Tool (SRT).',
    tags: ['Analytics', 'ROI', 'Reporting'],
    accent: 'Daten & Controlling',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-[#111] mb-4 leading-tight">
            Ihr Retail POS-Paket.
          </h2>
          <p className="text-base text-gray-500 max-w-xl mx-auto">
            Alles für maximale Sichtbarkeit und Verkaufserfolg am Point of Sale.
          </p>
        </div>
