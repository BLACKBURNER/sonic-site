      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to enter new markets? Get in touch with our expansion experts.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-100 p-8 hover:shadow-2xl transition-all">
            ...
            <a href="mailto:expansion@sonic.com" className="text-lg font-bold text-[#C8D400] hover:underline">
              expansion@sonic.com
            </a>
          </div>
