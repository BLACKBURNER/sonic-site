...
const STEPS = [
  {
    ...
    title: 'Erstgespräch',
    description: 'Wir analysieren Ihre Ziele, Produkte und Zielmarkt-Präferenzen.',
    accent: 'Analyse',
    duration: '1–2 Tage',
  },
  {
    ...
    description: 'Tiefgehende Analyse von Marktpotenzial, Wettbewerb und Regularien.',
    accent: 'Research',
    duration: '2–3 Wochen',
  },
  {
    ...
    description: 'Erstellung Ihrer individuellen Go-to-Market Strategie und Roadmap.',
    accent: 'Strategie',
    duration: '1–2 Wochen',
  },
  {
    ...
    description: 'Vermittlung relevanter Partner, Distributoren und lokaler Experten.',
    accent: 'Networking',
    duration: '2–4 Wochen',
  },
  {
    ...
    description: 'Operative Planung und Vorbereitung aller Launch-Aktivitäten.',
    accent: 'Launch-Planung',
    duration: '3–4 Wochen',
  },
  {
    number: '06',
    icon: 'ri-line-chart-line',
    title: 'Markteinführung & Monitoring',
    description: 'Begleitung beim Launch und kontinuierliche Optimierung.',
    accent: 'Ongoing',
    duration: 'Ongoing',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            Strukturiert und zielgerichtet zu Ihrem erfolgreichen Markteintritt.
          </p>
        </div>
