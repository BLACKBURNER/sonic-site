            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-4xl lg:text-5xl font-black text-white mb-6 leading-tight">
                  Bereit für Ihr<br />Dream-Team?
                </h2>
                
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Buchen Sie ein kostenloses Beratungsgespräch, um Ihre Staffing-Bedürfnisse zu besprechen und ein individuelles Angebot zu erhalten.
                </p>

                <ul className="space-y-4 mb-10">
                  {[
                    'Kostenfreie 30-Minuten Strategie-Session',
                    'Individueller Staffing-Plan und Preisangebot',
                    'Team-Profil-Empfehlungen',
                    'Schulungs- und Einsatz-Zeitplan',
                  ].map((item, index) => (
              ...
              <div className="relative">
                <div className="aspect-square overflow-hidden shadow-2xl" style={{ borderRadius: 0 }}>
                  <img
                    src="https://readdy.ai/api/search-image?query=professional%20staffing%20consultation%20meeting%20with%20team%20discussing%20brand%20ambassador%20recruitment%20strategy%20in%20modern%20bright%20office%20space&width=800&height=800&seq=staffconsult001&orientation=squarish"
                    alt="Consultation"
