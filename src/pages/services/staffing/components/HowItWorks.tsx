...
const STEPS = [
  {
    ...
    description: 'Wir definieren gemeinsam die Anforderungen an Ihr Personal.',
    accent: 'Analyse',
    duration: '1 Tag',
  },
  {
    ...
    icon: 'ri-search-line',
    title: 'Rekrutierung',
    description: 'Gezielte Suche und Vorauswahl passender Kandidaten aus unserem Pool.',
    accent: 'Sourcing',
    duration: '3–5 Tage',
  },
  {
    ...
    description: 'Interviews und Assessments zur finalen Kandidatenauswahl.',
    accent: 'Assessment',
    duration: '2–3 Tage',
  },
  {
    ...
    title: 'Schulung',
    description: 'Umfassende Produkt- und Markenschulung für alle Mitarbeiter.',
    accent: 'Training',
    duration: '1–2 Tage',
  },
  {
    ...
    description: 'Koordination und Planung aller Einsätze und Schichten.',
    accent: 'Koordination',
    duration: 'Ongoing',
  },
  {
    ...
    description: 'Kontinuierliches Monitoring und Performance-Optimierung.',
    accent: 'QM & Reporting',
    duration: 'Ongoing',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            Von der Anforderungsanalyse bis zum erfolgreichen Einsatz.
          </p>
        </div>
