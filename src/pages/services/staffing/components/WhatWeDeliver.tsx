...
const DELIVERABLES = [
  {
    ...
    description: 'Sorgfältig ausgewählte und geschulte Mitarbeiter für Ihre spezifischen Anforderungen — aus unserem umfangreichen Talentepool.',
    tags: ['Promoter', 'Hostessen', 'Verkäufer'],
  ...
  },
  {
    ...
    description: 'Produkt- und Markenschulungen für perfekte Repräsentation Ihrer Brand. Briefings, Rollenspiele, Markenidentität.',
    tags: ['Produktschulung', 'Markenwissen', 'Training'],
    accent: 'Wissen & Qualität',
  },
  {
    number: '03',
    icon: 'ri-calendar-line',
    title: 'Flexible Einsatzplanung',
    description: 'Bedarfsgerechte Personalplanung für Events, Kampagnen oder Dauereinsätze. Kurzfristig und zuverlässig.',
    tags: ['Events', 'Kampagnen', 'Dauereinsatz'],
    accent: 'Planung & Flexibilität',
  },
  {
    number: '04',
    icon: 'ri-shield-check-line',
    title: 'Qualitätssicherung',
    description: 'Kontinuierliches Monitoring und Feedback-Management für höchste Standards. Alles live im Sonic Reporting Tool (SRT).',
    tags: ['Monitoring', 'Feedback', 'Standards'],
    accent: 'Kontrolle & Reporting',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-base text-gray-500 max-w-xl mx-auto">
            Professionelles Personal für jeden Einsatz — zuverlässig und kompetent.
          </p>
        </div>
