      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to assemble your perfect team? Get in touch with our staffing experts.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-lg border-2 border-gray-100 p-8 hover:shadow-2xl transition-all" style={{ borderRadius: 0 }}>
            ...
            <a href="mailto:staffing@sonic.com" className="text-lg font-bold text-[#C8D400] hover:underline">
              staffing@sonic.com
            </a>
          </div>
