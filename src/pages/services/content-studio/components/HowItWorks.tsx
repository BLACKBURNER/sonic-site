...
const STEPS = [
  {
    ...
    description: 'Wir besprechen Ihre Ziele, Zielgruppe und gewünschten Content-Formate.',
    accent: 'Strategie',
    duration: '1–2 Tage',
  },
  {
    ...
    description: 'Terminkoordination, Location-Scouting und technische Vorbereitung.',
    accent: 'Planung',
    duration: '3–5 Tage',
  },
  {
    ...
    title: 'Produktion',
    description: 'Professionelle Aufnahmen in unserem Studio oder vor Ort bei Ihnen.',
    accent: 'Shooting',
    duration: '1–3 Tage',
  },
  {
    ...
    description: 'Bearbeitung, Retusche und Optimierung aller erstellten Inhalte.',
    accent: 'Editing',
    duration: '5–7 Tage',
  },
  {
    ...
    description: 'Sie prüfen die Ergebnisse und geben Feedback für finale Anpassungen.',
    accent: 'Review',
    duration: '2–3 Tage',
  },
  {
    ...
    title: 'Auslieferung',
    description: 'Finale Dateien in allen benötigten Formaten und Auflösungen.',
    accent: 'Delivery',
    duration: '1 Tag',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-sm text-gray-500 max-w-xl mx-auto">
            Von der ersten Idee bis zum fertigen Content — transparent und effizient.
          </p>
        </div>
