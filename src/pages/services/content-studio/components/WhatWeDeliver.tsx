...
const DELIVERABLES = [
  {
    ...
    description: 'Hochwertige Produktfotos, Lifestyle-Aufnahmen und Eventdokumentation für alle Kanäle — in unserem eigenen Studio oder vor Ort.',
    tags: ['Produktfotos', 'Lifestyle', 'Events'],
  ...
  },
  {
    ...
    icon: 'ri-film-line',
    title: 'Video Content',
    description: 'Von kurzen Social-Media-Clips bis zu ausführlichen Produktvideos und Imagefilmen. Schnitt, Color Grading und Vertonung inklusive.',
    tags: ['Social Media', 'Produktvideos', 'Imagefilme'],
    accent: 'Moving Image',
  },
  {
    number: '03',
    ...
    title: 'Grafik & Design',
    description: 'Visuelle Assets für Print und Digital, inklusive Infografiken, Werbematerialien und CI-konforme Markenadaptionen.',
    tags: ['Print', 'Digital', 'Infografiken'],
    accent: 'Design & CI',
  },
  {
    number: '04',
    ...
    description: 'Professionelle Nachbearbeitung und Optimierung aller erstellten Inhalte. Retusche, Farbkorrektur, Formatanpassung für jeden Kanal.',
    tags: ['Retusche', 'Farbkorrektur', 'Optimierung'],
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-base text-gray-500 max-w-xl mx-auto">
            Alles aus einer Hand — von der Konzeption bis zur finalen Auslieferung.
          </p>
        </div>
