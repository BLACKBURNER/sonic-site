            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-4xl lg:text-5xl font-black text-white mb-6 leading-tight">
                  Bereit für professionelle<br />Inhalte?
                </h2>
                
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  Buchen Sie ein kostenloses Beratungsgespräch, um Ihre Content-Bedürfnisse zu besprechen und ein individuelles Angebot zu erhalten.
                </p>

                <ul className="space-y-4 mb-10">
                  {[
                    'Kostenfreie 30-Minuten Strategie-Session',
                    'Individueller Content-Plan und Preisangebot',
                    'Studio-Tour und Equipment-Übersicht',
                    'Zeitplan und Deliverables-Besprechung',
                  ].map((item, index) => (
              ...
              <div className="relative">
                <div className="aspect-square overflow-hidden shadow-2xl" style={{ borderRadius: 0 }}>
                  <img
                    src="https://readdy.ai/api/search-image?query=professional%20content%20studio%20consultation%20meeting%20with%20creative%20team%20discussing%20brand%20strategy%20in%20modern%20bright%20office%20space%20with%20production%20equipment%20visible%20in%20background&width=800&height=800&seq=consultation001&orientation=squarish"
                    alt="Consultation"
